...
function initMobileMenu() {
    ...
    if (hamburger && navLinks) {
        hamburger.addEventListener('click', function() {
            toggleMobileMenu(hamburger, navLinks, navOverlay);
        });

        // Close menu when clicking on overlay
        if (navOverlay) {
            navOverlay.addEventListener('click', function() {
                closeMobileMenu(hamburger, navLinks, navOverlay);
            });
        }
...
function toggleMobileMenu(hamburger, navLinks, navOverlay) {
...
function closeMobileMenu(hamburger, navLinks, navOverlay) {
